...
const makeTemplate = (variant) => {
  ...
  template.innerHTML = `
        ...
        <header class="header-desktop">
            ...
            <div class="buttons-header-wrapper">
                <a href=${getPagePath("pagina-de-demandas")} style="${
    userType === "admin" ? "display: none" : ""
  }" class="header-button"><img class="dot-black" src="${rootPath}/assets/icons/dot-black.png">OPORTUNIDADES</a>
                ...
                <a id="area-da-ong" style="${
                  ...
                  userType === undefined
                    ? "display: none"
                    : ""
                }" href="#"  class="header-button"><img class="dot-black" src="${rootPath}/assets/icons/dot-black.png">ÁREA DA ONG</a>

                <a id="area-da-voluntario" style="${
                  userType === "organization" || userType === "admin"
                    ? "display: none"
                    : ""
                }" href="#"  class="header-button"><img class="dot-black" src="${rootPath}/assets/icons/dot-black.png">ÁREA DO VOLUNTÁRIO</a>
    ...
    "administrar-demandas"
  )}  class="header-button"><img class="dot-black" src="${rootPath}/assets/icons/dot-black.png">ADMINISTRAR DEMANDAS</a>
                ...
                ${
                  userType === "admin"
                    ? `
                    <a id="pagina-do-admin" href=${getPagePath(
                      "pagina-do-admin"
                    )} class="header-button"><img class="dot-black" src="${rootPath}/assets/icons/dot-black.png">PÁGINA DO ADMINISTRADOR</a>
                `
                    : ""
                }
